...
class SSD(Model):
    ...
    def init_vgg16(self):
        ...
        """
        origin_vgg = VGG16(weights='/mnt/sda2/lxl/code/ssd_origin/weight/vgg16_weights_tf_dim_ordering_tf_kernels.h5')
    ...
    def call(self, x):
        ...
        for layer in self.extra_layers:
            ...
            # print(str(head_idx)+str(x.shape))
